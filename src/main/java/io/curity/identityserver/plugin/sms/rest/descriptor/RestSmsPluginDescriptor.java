...
package io.curity.identityserver.plugin.sms.rest.descriptor;

import io.curity.identityserver.plugin.sms.rest.RestSmsSender;
...
public class RestSmsPluginDescriptor implements SmsPluginDescriptor
{
    @Override
    ...
    {
        return SmsRestPluginConfiguration.class;
    }

    @Override
    public Class<? extends SmsSender> getSmsSenderType()
    {
        return RestSmsSender.class;
    }
}
